    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(help_text='titre atelier ex: wubuquan, exercice souplesse', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.BooleanField(default=False, help_text='Rendre la fiche visible à tous (ex: Wubuquan)')),
                ('animateurs', models.ManyToManyField(blank=True, related_name='fiches_animateur', to=settings.AUTH_USER_MODEL)),
                ('participants', models.ManyToManyField(blank=True, related_name='fiches_participées', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image')),
                ('references', models.ManyToManyField(blank=True, help_text='Techniques associées ou similaires', related_name='referenced_by', to='fiches.technique')),
